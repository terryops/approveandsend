...
export const en = {
  ...
  "task.redraftAsk.intro": "Two ways to hand it back. Revise keeps the reply on the screen — your own edits included — and changes only what you ask for. Rewrite throws it away and tries a different approach; say which direction, or leave the box empty and let it choose. Either way the rule extractor reads what you write here.",
  "task.redraftAsk.placeholder": "Too formal. Lead with the refund, and do not apologise twice.",
  "task.redraftAsk.go": "Rewrite it",
  "task.redraftAsk.working": "Working…",
  "task.reviseAsk.go": "Revise it",
  "task.reviseAsk.needNote": "Revise needs to know what to change.",
  "task.save": "Save",
  ...
  "task.redraftDropped": "a redraft was already in progress, so this request did not run",
  ...
  "task.event.revise": "Revision asked for",
  ...
  "task.event.redraft_dropped": "Redraft skipped — one was already running",
