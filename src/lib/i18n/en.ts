...
export const en = {
  ...
  "task.askForOptions": "Other options",
  "task.options": "Other ways to answer ({n})",
  "task.optionsHint": "Different things to do, not different wording. Picking one keeps the draft it replaces.",
  "task.useOption": "Use this",
  "nav.compose": "Compose",
